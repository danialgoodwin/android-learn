...
public class MemeDatasource {
    ...
    public void delete(int memeId) {
        ...
        db.delete(MemeSQLiteHelper.ANNOTATIONS_TABLE, String.format("%s=%s",
                MemeSQLiteHelper.COLUMN_FOREIGN_KEY_MEME, String.valueOf(memeId)), null);
        db.delete(MemeSQLiteHelper.MEMES_TABLE, String.format("%s=%s",
                BaseColumns._ID, String.valueOf(memeId)), null);
    ...
    public ArrayList<Meme> readMemes() {
        ...
        Cursor cursor = db.query(MemeSQLiteHelper.MEMES_TABLE,
                ...
                null, //group by
                null, //having
                MemeSQLiteHelper.COLUMN_MEME_CREATE_DATE + " DESC"); // order by
    ...
    public void addMemeAnnotations(ArrayList<Meme> memes) {
        ...
        for (Meme meme : memes) {
            ...
            Cursor cursor = db.rawQuery("SELECT * FROM " + MemeSQLiteHelper.ANNOTATIONS_TABLE +
    ...
    public void update(Meme meme) {
        ...
        db.update(MemeSQLiteHelper.MEMES_TABLE, updateMemeValues, String.format("%s=%d", BaseColumns._ID, meme.getId()), null);
        ...
        for (MemeAnnotation annotation : meme.getAnnotations()) {
            ...
            if (annotation.hasBeenSaved()) {
                db.update(MemeSQLiteHelper.ANNOTATIONS_TABLE, updateAnnotations, String.format("%s=%d", BaseColumns._ID, annotation.getId()), null);
            } else {
                db.insert(MemeSQLiteHelper.ANNOTATIONS_TABLE, null, updateAnnotations);
            }
        }
